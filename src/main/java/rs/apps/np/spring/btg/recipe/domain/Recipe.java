...
//	private Integer servTime;
	...
	public Recipe addIngredient(Ingredient i) {
		log.info("Info Recipe, id: {} desc: {}, added Ingredient: {} ",this.getId(), this.getDescription(), i.getDescription() );
		log.debug("Debug Recipe, id: {} desc: {}, added Ingredient: {} ",this.getId(), this.getDescription(), i.getDescription() );
		i.setRecipe(this);
